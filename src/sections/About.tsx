        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
          ...
          />
            <div className="relative flex-1" ref={constraintRef}>
              {hobbies.map((hobby) => (
                <motion.div 
                key={hobby.title} className="inline-flex items-center gap-2 px-6 bg-gradient-to-r from-indigo-300 to-sky-400 rounded-full py-1.5 absolute"
                style={{
                  left: hobby.left,
                  top: hobby.top,
                }}
          ...
          <Card className="h-[320px] p-0 relatie md:col-span-2 lg:col-span-1">
            ...
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-300 to-sky-400 -z-20 animate-ping [animation-duration:2s]"></div>
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-300 to-sky-400 -z-10"></div>
